...
Then, for each ALIGNMENT.faa files, substitution models were evaluated using `modeltest v0.1.7` (doi: <https://10.1093/molbev/msz189>) to determine the most appropriate ML substitution model (based on the AICc criterion), followed by phylogenetic tree construction with `raxml-ng v1.1.0` (doi: <https://10.1093/bioinformatics/btz305>):
```
